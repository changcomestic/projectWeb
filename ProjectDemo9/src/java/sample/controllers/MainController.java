    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (action.equalsIgnoreCase("Login")) {
                url = LOGIN;
            } else if (action.equalsIgnoreCase("GetListCity")) {
                url = GETLISTCITY;
                ...
                url = UPDATE;
            } else if (action.equalsIgnoreCase("GetCityName")) {
                url = GETCITYNAME;
            } else if (action.equalsIgnoreCase("GetWayName")) {
                url = GETWAYNAME;
            } else if (action.equalsIgnoreCase("GetTypeName")) {
                url = GETTYPENAME;
            } else if (action.equalsIgnoreCase("GetDetailHouse")) {
//                HttpSession session = request.getSession();
//                session.setAttribute("DETAILHOUSE", null);
                url = GETDETAILHOUSE;
            } else if (action.equalsIgnoreCase("GetListWhenBeginning")) {
                url = GETLISTBEGINNING;
            }
        } catch (Exception ex) {
